...
public class TrainingFeedbackFrame extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TrainingFeedbackFrame frame = new TrainingFeedbackFrame();
	...
	public TrainingFeedbackFrame() {
		...
		panel_1.setBorder(new TitledBorder(new EtchedBorder(
				EtchedBorder.LOWERED, null, null), "\u57F9\u8BAD\u53CD\u9988",
		...
		final JButton button_1 = new JButton("\u57F9\u8BAD\u53CD\u9988");
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (table.getSelectedRow() == -1
					...
					System.out.println("请选择欲提交反馈的培训");
					return;
				}
				// 后台处理
				TrainingPlanBean obj = AllObj.trin_show.get(table
						.getSelectedRow());
				new TrainingTextFrame("培训反馈", obj).setVisible(true);
			}
		});
